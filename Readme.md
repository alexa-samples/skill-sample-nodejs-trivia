...
```text
Alexa, ask Reindeer Trivia to start a game.
	>> Welcome to American Reindeer Trivia. I will ask you five questions, try to get as many right as you can.
...
2. Simulate verbal interaction with your skill through the command line using the following example:
	...
	```bash
	 $ ask simulate -l en-US -t "alexa, start reindeer trivia"
