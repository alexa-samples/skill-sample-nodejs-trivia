...
7.  **Other testing methods to consider:**
    ...
    *  [Unit Testing with Alexa](https://github.com/alexa/alexa-cookbook/tree/master/guides/testing/postman.md) - a modern approach to unit testing your Alexa skills with [Postman](http://getpostman.com) and [Amazon API Gateway](http://aws.amazon.com/apigateway).
